            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="text" name="exam_type" value="<?php echo $exam_type; ?>" required="true" /> <br />
                        ...
                        <input type="submit" name="submit" value="Update Exam" class="btn-update" style="margin-left: 15%;" />
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($res===true)
                            {
                                $_SESSION['update']="<div class='success'>Exam successfully updated.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=exams');
                            }
                            else
                            {
                                $_SESSION['update']="<div class='error'>Failed to update exam. Please try again.</div>";
                                header('location:'.SITEURL.'admin/index.php?page=update_exam&id='.$exam_id);
                            }
                        }
                    ?>
                </div>
