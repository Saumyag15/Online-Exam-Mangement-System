<?php 
    ...
    Class Database
    {
        ...
        public function get_exam($tbl_name,$student_id,$conn)
        {
            $query="SELECT exam FROM $tbl_name WHERE student_id='$student_id'";
            $res=mysqli_query($conn,$query) or die(mysqli_error($conn));
            $row=mysqli_fetch_assoc($res);
            $exam=$row['exam'];
            return $exam;
        ...
        public function get_examname($tbl_name,$exam_id,$conn)
        {
            $query="SELECT exam_type FROM $tbl_name WHERE exam_id='$exam_id'";
            $res=mysqli_query($conn,$query) or die(mysqli_error($conn));
            $row=mysqli_fetch_assoc($res);
