                ...
                <div class="welcome">
                    ...
                    ?>
                     ...
                     <?php 
                        ...
                        //Calculate Marks for different exam
                        $obtainedMarks=$_SESSION['totalScore'];
                        $full_marks=$_SESSION['full_marks'];
                        $obtainedPercent=($obtainedMarks/$full_marks)*100;
                        //Get Student ID
                        //Get Exam ID from Student ID then Show full marks based on the exam and obtained percentage
                        if($_SESSION['examName']=='GRE')
                        {
                            $marksShown=260+round($obtainedPercent*0.8);
                        }
                        elseif($_SESSION['examName']=='GMAT')
                        {
